...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            function check()
            {
                 var userPwReal="${sessionScope.tea.loginPw}";
                 ...
                 loginService.teaPwEdit(document.formPw.userPw1.value,callback);
            }
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="90%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.tea.loginName}" name="userName" style="width: 250px;" disabled="disabled"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="10%" bgcolor="#FFFFFF" align="right">
