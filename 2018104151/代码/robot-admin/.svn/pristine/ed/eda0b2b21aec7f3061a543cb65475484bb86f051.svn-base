package com.zoneyet.robot.admin.dao.redis.impl;
...
import com.zoneyet.robot.admin.dao.AbstractBaseRedisDao;
import com.zoneyet.robot.admin.dao.redis.RedisDao;
import com.zoneyet.robot.admin.util.DbFH;
...
public class RedisDaoImpl extends AbstractBaseRedisDao<String, PageData> implements RedisDao{
	  ...
	  private String keyPrefix = "robot_cache:";
	/**新增(存储字符串)
	 * @param key
	 * @param value
	 * @return
	...
	public boolean addString(final String key, final String value) {
		String key2=this.keyPrefix+key;
		boolean result = redisTemplate.execute(new RedisCallback<Boolean>() {  
            public Boolean doInRedis(RedisConnection connection)  
                    throws DataAccessException {  
                RedisSerializer<String> serializer = getRedisSerializer();  
                byte[] jkey  = serializer.serialize(key2);  
	...
	/**删除
	 * (non-Javadoc)
	 * @see com.zoneyet.robot.admin.dao.redis.RedisDao#delete(java.lang.String)
	 */
	@Override
	...
	/**删除多个
	 * (non-Javadoc)
	 * @see com.zoneyet.robot.admin.dao.redis.RedisDao#delete(java.util.List)
	 */
	@Override
	...
	/**修改
	 * (non-Javadoc)
	 * @see com.zoneyet.robot.admin.dao.redis.RedisDao#eidt(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**通过key获取值
	 * (non-Javadoc)
	 * @see com.zoneyet.robot.admin.dao.redis.RedisDao#get(java.lang.String)
	 */
	@Override
	public String get(final String keyId) {
		String key2=this.keyPrefix+keyId;
