					...
					<form action="key/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="password" name="APPID" id="APPID" value="${pd.APPID}" maxlength="100" placeholder="这里输入appid" title="appid" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">appsecret:</td>
								<td><input type="password" name="APPSECRET" id="APPSECRET" value="${pd.APPSECRET}" maxlength="100" placeholder="这里输入appsecret" title="appsecret" style="width:98%;"/></td>
							</tr>
							<tr>
