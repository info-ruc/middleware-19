package com.zoneyet.robot.admin.util.mail;
  ...
  */    
    ...
    public static void main(String[] args) throws Exception{   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setMailServerPort("25");    
	     mailInfo.setValidate(true);    
	     mailInfo.setUserName("luoxiaofei1996@163.com");    
	     mailInfo.setPassword("lxf111");//您的邮箱密码    
	     mailInfo.setFromAddress("luoxiaofei1996@163.com");    
	     mailInfo.setToAddress("634147618@qq.com");    
