package com.zoneyet.robot.admin.controller.system.fhlog;
...
public class FHlogController extends BaseController {
	...
	public ModelAndView exportExcel(Page page,String keywords,String lastStart,String lastEnd) throws Exception{
		...
		page.setPd(pd);
		List<PageData>	varOList = fhlogService.excellist(page);		//列出FHlog列表
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var4", varOList.get(i).getString("CZTIME"));
			varList.add(vpd);
		}
