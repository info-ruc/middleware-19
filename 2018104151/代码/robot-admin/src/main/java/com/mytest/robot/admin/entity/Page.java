package com.zoneyet.robot.admin.entity;
...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("		//alert(toPaggeVlue);\n");
			sb.append("		if(isNum(toPaggeVlue)){ //如果是整数\n");
			...
			sb.append("function isNum(s) {\n");
			sb.append("			if(s.indexOf('.') == -1){//是整数\n");
