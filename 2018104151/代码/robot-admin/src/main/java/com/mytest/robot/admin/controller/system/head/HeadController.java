package com.zoneyet.robot.admin.controller.system.head;
...
import com.zoneyet.robot.admin.service.system.userphoto.UserPhotoManager;
...
import com.zoneyet.robot.admin.util.SmsUtil;
import com.zoneyet.robot.admin.util.Tools;
import com.zoneyet.robot.admin.util.Watermark;
import com.zoneyet.robot.admin.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/goSendNotice")
	public ModelAndView goSendNotice() throws Exception{
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/head/send_notice");
		mv.addObject("msg", "sendNotice");
		mv.addObject("pd", pd);
		return mv;
	}
	...
	public ModelAndView goEditEmail() throws Exception{
		if(!"admin".equals(Jurisdiction.getUsername())&&!"robotadmin".equals(Jurisdiction.getUsername())){return null;}	//非admin用户不能修改
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
