...
Team team =gs.getTeamInfo(teamId);

ArrayList<Programmer> teamMember = ts.getTeamMemberInfo(teamId);
ArrayList<Programmer> applyMember = ts.getTeamApplyInfo(teamId);
ArrayList<Bid> bidMember = ts.getTeamBidInfo(teamId);

String temp=team.getLeaderId(); 
%>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">团队详情</a>
                </li>
			...
			<c:if test="${user.getType()=='0' }">
				<%Programmer tempP=(Programmer)user; %>
				<c:set value="<%=tempP.getPid() %>" var="varName" />  
				<c:set value="<%=team.getLeaderId() %>" var="varName2" />  
			</c:if>
                                ...
                                <div class="form_center">
                                    ...
                                    <div class="well">
                                         <div class="control-group">
                                                ...
                                                <label class="control-label"><%=teamId%></label>
                                    ...
                                    <div class="well">
                                         <div class="control-group">
                                                ...
                                                <label class="control-label"><%=team.getTeamName() %></label>
                                         </div>
                                    </div>
                                    <div class="well">
                                         <div class="control-group">
                                                 <label class="control-label">团队介绍</label>
                                                <label class="control-label"><%=team.getProfile() %></label>
                                         </div>
                                    </div>
                                    <div class="well">
                                         <div class="control-group">
                                                 <label class="control-label">队长名称</label>
                                                <label class="control-label"><%=gs.getProgrammerInfo(team.getLeaderId()).getRealName()  %></label>
                                         </div>
                                    </div>
<c:if test="${user.getType()=='0'}">		
					  <input type="button" value="申请入队"  class="btn btn-info pull-right"   onclick="window.location.href='${pageContext.request.contextPath }/ApplyForTeamServlet?pid=${user.getPid() }&tid=<%=team.getTeamId()%>';"/>
				</c:if>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="Blank_PageClose">
                            ...
                            <div class="body-nest" id="Blank_Page_Content">
                                ...
                                <div class="form_center">
                                <c:forEach items="<%=teamMember %>" var="keyword" varStatus="id">

                                    <div class="well">
                                         <div class="control-group">
                                                 <label class="control-label">真实姓名</label>
                                                <label class="control-label">${keyword.getRealName() }</label>
                                         </div>
                                    </div>
                                    
                                    <c:if test="${user.getType()=='0'&&varName==varName2}">
									   	 <a href="${pageContext.request.contextPath}/DeleteMemberServlet?pid=${keyword.getPid() }&tid=<%=teamId%>">删除成员</a>	
									</c:if>
				</c:forEach>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="Blank_PageClose">
                            ...
                            <div class="body-nest" id="Blank_Page_Content">
                                ...
                                <div class="form_center">
                                <c:forEach items="<%=applyMember %>" var="keyword" varStatus="id">
				...
				name="reg" >
                                    ...
                                    <div class="well">
                                         <div class="control-group">
                                                <label class="control-label">程序员id</label>
                                                <label class="control-label">${keyword.getPid() }</label>
									...
									<a href="${pageContext.request.contextPath}/ResponseServlet?pid=${keyword.getPid() }&tid=<%=teamId%>&ans=1">确认申请</a>
								    <a href="${pageContext.request.contextPath}/ResponseServlet?pid=${keyword.getPid() }&tid=t<%=teamId%>&ans=0">拒绝申请</a>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="nest" id="Blank_PageClose">
                            ...
                            <div class="body-nest" id="Blank_Page_Content">
                                ...
                                <div class="form_center">
                                <c:forEach items="<%=bidMember %>" var="keyword" varStatus="id">
				<form class="smart-green" method="post"
				action="${pageContext.request.contextPath }/IssueProjectServlet"
				name="reg" >
                                    ...
                                    <div class="well">
                                         <div class="control-group">
                                                <label class="control-label">招标id</label>
                                                <label class="control-label">${keyword.getBidId() }</label>
                                    ...
                                    <div class="well">
                                         <div class="control-group">
                                                ...
                                                <label class="control-label">${keyword.getBudget() }</label>
                                         </div>
                                    </div>
                                    <div class="well">
                                         <div class="control-group">
                                                 <label class="control-label">是否被选中</label>
                                                <label class="control-label">${keyword.isConfirmed() }</label>
                                         </div>
                                    </div>
